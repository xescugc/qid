...
func createResourceVersion(s qid.Service) http.HandlerFunc {
...
func listResourceVersions(s qid.Service) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var (
...
func getPipelineResource(s qid.Service) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var (
...
func updatePipelineResource(s qid.Service) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var (
...
func triggerPipelineResource(s qid.Service) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var (

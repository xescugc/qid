...
//go:generate go tool mockgen -destination=../mock/team_repository.go -mock_names=Repository=TeamRepository -package mock github.com/xescugc/qid/qid/team Repository

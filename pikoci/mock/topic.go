...
// Source: github.com/xescugc/pikoci/pikoci/queue (interfaces: Topic)
//
// Generated by this command:
//
//	mockgen -destination=../mock/topic.go -mock_names=Topic=Topic -package mock github.com/xescugc/pikoci/pikoci/queue Topic
//

...
//
//	mockgen -destination=pikoci/mock/pipeline_repository.go -mock_names=Repository=PipelineRepository -package mock github.com/xescugc/pikoci/pikoci/pipeline Repository
//
